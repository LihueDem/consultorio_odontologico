        ...
        <div className="row">
          <Card className="recomendacion-card">
            ...
            <Card.Body>
              ...
              <Card.Text>
                Las placas de relajación suelen emplearse para evitar el
                bruxismo mientras el paciente duerme. Este método ayuda a
                prevenir los daños en los dientes y los problemas en la
